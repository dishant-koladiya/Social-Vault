			...
			<div className="w-full">
				{adminNavlinks.map((link, index) => (
					<NavLink
						...
						className={({ isActive }) =>
							`relative flex items-center max-md:justify-center gap-2 w-full py-2.5 min-md:pl-10 first:mt-6 text-gray-600 ${isActive && "bg-indigo-500/10 text-indigo-600 group"}`
						}
					>
						{({ isActive }) => (
							<>

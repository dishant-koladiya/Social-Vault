...
const Dashboard = () => {
	...
	const [loading, setLoading] = useState(true);
	const [dashboardData, setDashboardData] = useState({
		totalListing: 0, // ✅ matches backend key
		totalRevenue: 0,
		activeListings: 0,
		totalUser: 0,
		recentListings: [],
	...
	const dashboardCards = [
		{
			title: "Total Listings",
			value: dashboardData.totalListing || "0", // ✅ fixed key
			icon: ChartLineIcon,
		},
		{
			title: "Total Revenue",
			value: currency + (dashboardData.totalRevenue || 0).toLocaleString(), // ✅ fixed operator precedence
			icon: CircleDollarSignIcon,
		},
		{
			title: "Active Listings",
